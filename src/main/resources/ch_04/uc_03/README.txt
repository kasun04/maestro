...
curl -v -X POST -H 'Content-Type: text/xml' -H 'SOAPAction: http://www.example.org/BankInfoProxyService/getBankInformation' -d @getSimpleQuote.xml http://127.0.0.1:8280/services/StockQuoteProvider
